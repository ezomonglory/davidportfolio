				...
				<div className='md:mx-[80px] mx-[16px] mt-[34px]  '>
					...
					<div className='md:mx-[60px] flex flex-col space-y-[48px] '>
						...
						<div>
							...
							<div className='bg-[#F9F9F9] rounded-[4px] py-[64px] px-[81px] '>
                                <img src="/Lecturer's Dashboard AttendX web.png" alt="Lecturer's Dashboard AttendX web" className="w-full" />
                            </div>
						</div>
						...
						<div>
							...
							<div className='bg-[#F9F9F9] rounded-[4px] py-[64px] px-[81px] '>
                                <img src="/Student dashboard AttendX web.png" className="w-full" />                                
                            </div>
						</div>
						...
						<div>
							...
							<div className='bg-[#F9F9F9] rounded-[4px] py-[64px] px-[81px] '>
                                <img src="/Mobile responsiveness AttendX Web.png" className="w-full" />
                            </div>
						</div>
